    ...
    <main class="px-14 py-9 bg-white max-md:px-[2rem] max-md:py-[1.25rem]">
      <div class="flex flex-col gap-[1rem]">
        ...
        <div class="flex flex-wrap gap-[1rem] justify-center items-start max-md:gap-3">
          ...
          <button class="px-[0.5rem].5 py-[1.25rem] text-2xl text-[#803D3D] bg-[#FFE5E1] rounded-[0.5rem] cursor-pointer w-[11.25rem] max-md:px-[0.5rem] max-md:py-[1rem] max-md:text-xl max-md:w-[9.375rem]">
            Tổng tài
          </button>
          <button class="px-[0.5rem].5 py-[1.25rem] text-2xl text-[#803D3D] bg-[#FFE5E1] rounded-[0.5rem] cursor-pointer w-[11.25rem] max-md:px-[0.5rem] max-md:py-[1rem] max-md:text-xl max-md:w-[9.375rem]">
            Thế thân

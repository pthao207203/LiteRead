      ...
      <div class="flex flex-col justify-center items-center mx-auto w-full ">
        <div class="flex flex-col sm:flex-row sm:gap-4 md:gap-6">
          ...
          <div class="flex flex-col items-start mt-3 lg:w-3/4 sm:w-2/3 w-[24.625rem] gap-2.5 justify-end">
            <h1 id="book-title"
              class="flex shrink gap-2.5 self-end w-full md:text-[2rem] max-sm:text-[1.25rem] font-bold leading-7 text-red-normal uppercase">
              <?php echo esc_html($story->story_name); ?>
            </h1>
            <div class="flex gap-1 justify-center items-center" aria-label="Book rating">
              <span
                class="self-stretch my-auto max-sm:text-[1.125rem] md:text-[1.875rem] text-red-normal"><?php echo esc_html($story->rate); ?></span>
              <div class="flex items-end self-center my-auto max-sm:text-[1.25rem] md:text-[2rem]" role="img">
            ...
            <div class="flex flex-wrap gap-2.5 items-center self-stretch mt-2.5 w-full" aria-label="Book categories">
              ...
              foreach ($genres as $genre) {
                echo '<span class="px-2.5 py-1 max-sm:text-[0.875rem] md:text-[1.5rem] font-normal text-[#593B37] bg-orange-light-active rounded-lg">'
                  . esc_html(trim($genre)) .
                  '</span>';
              }
              ?>
    ...
    <div class="flex md:flex-row flex-col w-full max-md:max-w-full">
      <div class="flex flex-col max-md:p-4 px-14 py-14 gap-10 max-md:gap-4 md:w-8/12 box-border w-full">
        ...
        <section class="flex flex-col bg-white justify-center items-center  mx-auto w-full "
          ...
          <div
            class="flex overflow-x-auto flex-1 mt-3 max-sm:text-[1rem] md:text-[1.75rem] whitespace-nowrap bg-white size-full text-[#593B37]"
            role="region" aria-label="Scrollable content">
          </div>
          <div
            class="flex-1 shrink basis-0 text-ellipsis max-sm:text-[1rem] md:text-[1.75rem] font-normal text-[#593B37] [&>p]:mb-4">
          ...
          <nav class="flex overflow-x-auto flex-col justify-center mt-3 w-full bg-white text-[#593B37]"
            ...
            <ul class="list-none p-0 mx-2">
              <li
                ...
                <a href="#chapter1"
                  class="flex-1 shrink self-stretch my-auto max-sm:text-[1rem] md:text-[1.75rem] font-medium basis-0">Chương
                  1</a>
                <span class="self-stretch my-auto max-sm:text-[0.875rem] md:text-[1.5rem] font-normal">10 tiếng
                  trước</span>
              </li>
              <li
                class="flex gap-2.5 justify-center items-center py-1.5 w-full border-solid border-b-[0.1px] border-b-[#593B37]/50">
              ...
              <article
                ...
                <div class="flex-1 shrink basis-0  max-md:max-w-full">
                  <header class="flex flex-wrap md:gap-10 gap-1 justify-between items-center w-full max-md:max-w-full">
                    ...
                    <time class="self-stretch my-auto max-sm:text-[0.875rem] md:text-[1.5rem] text-right">9 giờ
                      trước</time>
                  </header>
                  <p
      ...
      <aside
        ...
        <div class="flex flex-col items-center mt-[12px] md:mt-[24px] w-full" role="tabpanel">
          ...
          <article class="flex gap-3 w-full mb-[12px] md:mb-[24px]">
            <span
              class="gap-2.5 self-center my-auto w-[2rem] h-[2rem] max-sm:text-[1rem] md:text-[1.25rem] p-0.5 font-medium text-center text-red-normal whitespace-nowrap rounded-[2px] border"
            ...
            <div class="flex flex-col flex-1 shrink self-stretch my-auto basis-0 ">
              ...
              <div class="flex gap-1 items-start self-start mt-[4px] ">
                <div class="flex items-start" aria-label="Rating: 4 out of 5">
                  <span
                    class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.25rem] md:h-[1.75rem] max-sm:text-[1rem] md:text-[1.5rem]">★</span>
                  <span
                    class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.25rem] md:h-[1.75rem] max-sm:text-[1rem] md:text-[1.5rem]">★</span>
                  <span
                    class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.25rem] md:h-[1.75rem] max-sm:text-[1rem] md:text-[1.5rem]">★</span>
          ...
          <article class="flex gap-3 items-center w-full mb-[12px] md:mb-[24px]">
            <span
              class="gap-2.5 self-center my-auto w-[2rem] h-[2rem] p-0.5 max-sm:text-[1rem] md:text-[1.25rem] font-medium text-center text-red-normal whitespace-nowrap rounded-[2px] border"
          ...
          <article class="flex gap-3 items-center w-full mb-[12px] md:mb-[24px]">
            <span
              class="gap-2.5 self-center items-center my-auto w-[2rem] h-[2rem] p-0.5 max-sm:text-[1rem] md:text-[1.25rem] font-medium text-center text-red-normal whitespace-nowrap rounded-[2px] border"
      ...
      <h2 class="gap-2.5 self-start p-[10px] md:px-[20px] ml-[17px] md:ml-[34px] mb-[-3px] max-sm:text-[1.125rem]  md:text-[2.25rem] font-semibold text-red-normal bg-red-light rounded-tl-[12px] rounded-tr-[12px]">
        ...
        <div
          ...
          <article class="flex flex-col self-stretch my-auto min-h-[261px] w-[121px] shrink-0 md:w-auto" role="listitem">
            ...
            <span
              class="gap-2.5 self-start px-[2px] mt-[4px] md:my-[8px] max-sm:text-[0.75rem] md:text-[1.25rem] font-medium text-red-light whitespace-nowrap bg-red-normal rounded-[2px]">Full</span>
            <div class="flex flex-col mt-[4px] w-full">
              <h3
                class="flex-1 shrink gap-2.5 self-stretch w-full max-sm:text-[1rem] md:text-[1.75rem] font-medium basis-0 text-orange-darker break-words">
                Thiên Quan Tứ Phúc
              </h3>
              <div class="flex gap-1 items-start self-start mt-[4px] ">
                <div class="flex items-start" aria-label="Rating: 4 out of 5">
                  <span
                    class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.75rem] md:h-[1.75rem] max-sm:text-[1rem] md:text-[2rem]">★</span>
                  <span
                    class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.75rem] md:h-[1.75rem] max-sm:text-[1rem] md:text-[2rem]">★</span>
                  <span
                    class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.75rem] md:h-[1.75rem] max-sm:text-[1rem] md:text-[2rem]">★</span>
              ...
              <p
                class="flex-1 shrink gap-2.5 self-stretch mt-1 w-full max-sm:text-[0.875rem] md:text-[1.5rem] text-normal text-red-normal basis-0">
                Chương 120
              </p>
            </div>
          </article>
          ...
          <article class="flex flex-col self-stretch my-auto min-h-[261px] w-[121px] shrink-0 md:w-auto" role="listitem">
            ...
            <div class="flex flex-col mt-[4px] w-full">
              ...
              <p
                class="flex-1 shrink gap-2.5 self-stretch mt-1 w-full max-sm:text-[0.875rem] md:text-[1.25rem] text-normal text-red-normal basis-0">
                Chương 120
              </p>
            </div>
          </article>

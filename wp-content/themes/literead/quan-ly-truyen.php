...
if ($story) {
  ...
  <main class="flex flex-col bg-[#FFE5E1]">
    <div class="w-full max-md:max-w-full">
        ...
        <div class="md:px-[3.5rem] md:py-[2.125rem] p-[1rem]">
          <article
          ...
          >
            <div class="rounded-md w-auto max-sm:h-[13.75rem] max-h-[23.25rem]">
              <img src=<?php echo esc_url($story->cover_image_url); ?> alt=<?php echo esc_html($story->story_name); ?>
                alt="Story cover" class="object-cover rounded-lg  w-auto max-sm:h-[13.75rem] lg:w-[16.625rem] max-h-[23.25rem]" />
            </div>
            <div class="w-auto max-sm:w-1/2">
              ...
              <p class="mb-2 text-[16px] md:text-[1.75rem] text-red-darker">Số chữ: <?php echo esc_html($total_count) ?></p>
              ...
              ?></p>
              <p class="mb-2 text-[16px] md:text-[1.75rem] text-red-darker">Số chương: <?php echo esc_html($total_chapter) ?></p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              foreach ($chapters as $chapter) {
                ...
                <article
                  ...
                  <p class="text-[16px] md:text-[1.5rem] italic text-red-darker">Cập nhật: <?php echo time_ago($chapter->edited_at); ?></p>
                </article>
                <?php
              } ?>
            </div>

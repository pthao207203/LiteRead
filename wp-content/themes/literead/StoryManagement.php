...
<section class="flex p-4 ml-10 mr-10 mt-5 md-5 bg-white rounded-2xl shadow-md max-md:w-full">
  <div class="overflow-hidden rounded-md w-[16.625rem] h-[23.25rem]">
    <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/f0be899499f251023e5ce724a21ead738766fbc1" alt="Story cover"
          class="object-cover w-[16.625rem] h-[23.25rem]" />
  </div>
  <div class="ml-6 max-md:mt-5">
    <h1 class="mb-2 text-4xl font-medium text-[#4B2423]">Thiên quan tứ phúc</h1>
    ...
    <p class="mb-2 text-3xl text-[#4B2423]">Thể loại: Truyện dịch</p>
    <p class="mb-2 text-3xl text-[#4B2423]">Số chương: 120</p>
    <p class="mb-2 text-3xl text-[#4B2423]">Lượt đọc: 33.3k</p>
    <p class="mb-2 text-3xl text-[#4B2423]">Yêu thích: 12K</p>
    <p class="mb-2 text-3xl text-[#4B2423]">Bình luận: 200</p>
  </div>
</section>
<section class=" ml-10 mr-12 px-0 py-4">
  <button class="px-3 py-3.5 text-3xl font-medium text-[#D56665] bg-[#FFF2F0] rounded-xl max-sm:text-2xl"> Giới thiệu
  </button>
  <button class="px-3 py-3.5 ml-2 text-3xl font-medium text-[#FBF6E3] bg-[#D56665] rounded-xl max-sm:text-2xl"> Sửa
  </button>
  <form class="px-2.5 py-4 mx-0 my-4 text-3xl rounded-lg border border-solid border-[#D56665] max-sm:text-xl">
    <textarea class="w-full h-auto p-2 text-3xl text-[#4B2423] border-none resize-none bg-transparent" rows="6">
        Trời mùa thu dịu nhẹ, nắng vàng rơi trên những con đường lát gạch cổ kính. Giữa nhịp sống vội vã của thành phố, cô vô tình gặp anh - một khoảnh khắc tưởng như thoáng qua nhưng lại khắc sâu vào tâm trí. Hôm đó, An đứng trước quán cà phê quen thuộc, vội vàng lục tìm chiếc điện thoại trong túi khi một làn gió nhẹ cuốn theo những chiếc lá vàng bay lượn quanh cô. Đúng lúc ấy, một người đàn ông từ trong quán bước ra. Anh mặc sơ mi trắng, quần tây sẫm màu, dáng người cao gầy nhưng trông lại vô cùng thanh lịch. Gió nhẹ làm vài sợi tóc anh rối lên, nhưng ánh mắt anh - trầm tĩnh mà dịu dàng - khiến người ta không thể rời đi.
    </textarea>
  </form>
<div>
    <button class="px-3 py-3.5 text-3xl font-medium text-[#D56665] bg-[#FFF2F0] rounded-xl max-sm:text-2xl"> Danh sách chương
    </button>
  <div class="flex gap-3 mt-4 mb-6">
    <button class="px-3 py-3.5 text-3xl font-medium text-[#FBF6E3] bg-[#D56665] rounded-xl max-sm:text-2xl"> Chương mới
    </button>
    <button class="flex items-center text-3xl px-3 py-3.5 font-medium text-[#FBF6E3] bg-[#D56665] rounded-xl max-sm:text-2xl">
      <svg width="20" height="20" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg"
           class="delete-icon mr-2.5">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M28 8.5H4V12.5C4.61998 12.5 4.92997 12.5 5.1843 12.5681C5.87449 12.7531 6.41358 13.2922 6.59852 13.9824C6.66667 14.2367 6.66667 14.5467 6.66667 15.1667V22.5C6.66667 25.3284 6.66667 26.7426 7.54535 27.6213C8.42403 28.5 9.83824 28.5 12.6667 28.5H19.3333C22.1618 28.5 23.576 28.5 24.4547 27.6213C25.3333 26.7426 25.3333 25.3284 25.3333 22.5V15.1667C25.3333 14.5467 25.3333 14.2367 25.4015 13.9824C25.5864 13.2922 26.1255 12.7531 26.8157 12.5681C27.07 12.5 27.38 12.5 28 12.5V8.5ZM13.6667 15.1667C13.6667 14.6144 13.219 14.1667 12.6667 14.1667C12.1144 14.1667 11.6667 14.6144 11.6667 15.1667V21.8333C11.6667 22.3856 12.1144 22.8333 12.6667 22.8333C13.219 22.8333 13.6667 22.3856 13.6667 21.8333V15.1667ZM20.3333 15.1667C20.3333 14.6144 19.8856 14.1667 19.3333 14.1667C18.781 14.1667 18.3333 14.6144 18.3333 15.1667V21.8333C18.3333 22.3856 18.781 22.8333 19.3333 22.8333C19.8856 22.8333 20.3333 22.3856 20.3333 21.8333V15.1667Z" fill="white">
        </path>
        <path d="M13.424 4.99412C13.576 4.85237 13.9108 4.7271 14.3765 4.63776C14.8422 4.54843 15.4128 4.5 15.9998 4.5C16.5869 4.5 17.1575 4.54842 17.6232 4.63776C18.0889 4.7271 18.4237 4.85236 18.5756 4.99412" stroke="white" stroke-width="2" stroke-linecap="round">
        </path>
      </svg>
      <span>Xóa</span>
    </button>
...
<div class="grid grid-cols-2 md:grid-cols-3 gap-4">
  <article class="p-4 bg-white rounded-2xl border-l-2 border-solid shadow-md border-l-[#D56665] max-sm:p-4 w-[30.625rem] h-[10.32rem]">
  ...
  <article class="p-4 bg-white rounded-2xl border-l-2 border-solid shadow-md border-l-[#D56665] max-sm:p-2 w-[30.625rem] h-[10.32rem]">

...
if (!$user_info) {
  echo "<script>alert('Không tìm thấy thông tin người dùng. Vui lòng liên hệ với quản trị viên!'); window.location.href='/';</script>";
  exit();
}
        ...
        <div class="w-full max-md:mt-5 max-md:max-w-full">
          <section class="px-[3.5rem] py-[2.125rem] max-w-full w-[1520px] bg-white">
            ...
            <nav class="flex gap-2 items-start self-start mt-12 text-[1.875rem] font-medium max-md:mt-10">
              ...
              <div class="">
                <button type="button" id="editButton" class="gap-2.5 px-[1.25rem] py-[0.625rem] bg-[#D56665] hover:bg-[#C05C5B] hover:text-[#FFF2F0] text-[#FFF7F5] rounded-xl">
                  Sửa
                </button>
            ...
            <form method="POST" enctype="multipart/form-data">
              ...
              <section class="mt-12 w-full text-[1.75rem] text-[#A04D4C] max-md:mt-10 max-md:max-w-full">
                <div class="flex flex-wrap gap-[1.375rem] items-start w-full max-md:max-w-full">
                  ...
                  <div class="grow shrink tracking-wide leading-none whitespace-nowrap min-w-60 w-[566px] max-md:max-w-full">
                  ...
                  <div class="grow shrink tracking-wide leading-none min-w-60 w-[566px] max-md:max-w-full">
                    <label for="ngaythamgia" class="font-semibold  tracking-wide leading-none max-md:max-w-full">Ngày tham gia</label>
                    <div class="overflow-hidden bg-[#F0F3F5]  w-full max-md:max-w-full text-[#A04D4C]">
                      <input type="date" id="ngaythamgia" name="ngaythamgia" value="<?php echo esc_attr($created_at_display); ?>" readonly
                  ...
                  <div class="grow shrink tracking-wide leading-none min-w-60 w-[566px] max-md:max-w-full">
                    ...
                    <div class="overflow-hidden bg-[#F0F3F5]  w-full max-md:max-w-full text-[#A04D4C]">
                      <input type="date" id="Capnhat" name="Capnhat" value="<?php echo esc_attr($updated_at_display); ?>" readonly
                        class="overflow-hidden px-[0.5rem] py-[1rem] mt-4 w-full font-medium border-b border-solid border-b-[color:var(--Foundation-Red-red-Dark,#A04D4C)] outline-none max-md:max-w-full" />
                    </div>
                  </div>
            ...
            <section class="mt-12 max-md:mt-10">
              ...
              <div class="mt-12 w-full text-pink-800 max-md:mt-10 max-md:max-w-full">
                ...
                <div class="flex flex-wrap gap-3 items-start mt-[0.75rem] w-full max-md:max-w-full">
                  ...
                  <article
                    class="flex flex-col flex-1 shrink justify-center p-[1.25rem] bg-[#FFF2F0] rounded-xl basis-0 min-w-60 max-md:max-w-full">
                    <p class="text-[1.875rem] font-regular"><?php echo esc_html($user_coin); ?>K</p>
                ...
                <div class="flex flex-wrap gap-3 items-start mt-[0.75rem] w-full max-md:max-w-full">
                  ...
                  <article
                    class="flex flex-col flex-1 shrink justify-center p-[1.25rem] bg-[#FFF2F0] rounded-xl basis-0 min-w-60 max-md:max-w-full">
                    <p class="text-[1.875rem] font-regular"><?php echo esc_html($total_views); ?>K</p>
...
<div id="confirmPopup" class="popup-overlay hidden">
  <div class="popup-content flex flex-col">
    <svg
      ...
      class="w-[3.125rem] h-[3.125rem] flex-shrink-0 mx-auto"
      aria-hidden="true">
  ...
  <div class="popup-content flex-col justify-center">
    <div
      ...
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg">
        <path
          d="M1.88889 9.24609L10.2222 17.5794L24.1111 0.912598"
          stroke="white"
          stroke-width="2"></path>
      </svg>
    </div>

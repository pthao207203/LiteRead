...
<main class="home w-full max-md:max-w-full">
    ...
    <div class="flex flex-col justify-center items-center mx-auto w-full ">
        ...
        <img
            ...
            class="object-contain lg:w-1/4 sm:w-1/3 w-[24.625rem] shrink-0  rounded-lg aspect-[0.64]"
        ...
        <div class="flex flex-col items-start mt-3 lg:w-3/4 sm:w-2/3 w-[24.625rem] gap-2.5 justify-end">
            <h1 id="book-title" class="flex shrink gap-2.5 self-end w-full md:text-[2rem] max-sm:text-[1.25rem] font-bold leading-7 text-red-normal uppercase">
            Sổ tay bạch liên hoa lừa người
            </h1>
            <div class="flex gap-1 justify-center items-center" aria-label="Book rating">
            <div class="flex items-end self-center my-auto max-sm:text-[1.25rem] md:text-[2rem]" role="img" aria-label="4 out of 5 stars">
            ...
            <span class="self-stretch my-auto max-sm:text-[1.125rem] md:text-[1.875rem] text-red-normal">4</span>
            </div>
            <dl class="w-full max-sm:text-[1rem] md:text-[1.75rem]">
            <div class="flex gap-2.5 self-stretch max-sm:text-[1rem] md:text-[1.75rem]">
                <dt class="font-semibold text-[#593B37]">Tác giả:</dt>
                <a>
                <dd class="font-normal text-[#593B37]">Giang Thành Nhị Lang</dd>
                </a>
            </div>
            <div class="flex gap-2.5 self-stretch max-sm:text-[1rem] md:text-[1.75rem] mt-2.5">
            ...
            <span class="px-2.5 py-1 max-sm:text-[0.875rem] md:text-[1.5rem] font-normal text-[#593B37] bg-orange-light-active rounded-lg">HE</span>
            <span class="px-2.5 py-1 max-sm:text-[0.875rem] md:text-[1.5rem] font-normal text-[#593B37] bg-orange-light-active rounded-lg">Ngôn tình</span>
            <span class="px-2.5 py-1 max-sm:text-[0.875rem] md:text-[1.5rem] font-normal text-[#593B37] bg-orange-light-active rounded-lg">Ngọt sủng</span>
            <span class="px-2.5 py-1 max-sm:text-[0.875rem] md:text-[1.5rem] font-normal text-[#593B37] bg-orange-light-active rounded-lg">Cổ đại</span>
            <span class="px-2.5 py-1 max-sm:text-[0.875rem] md:text-[1.5rem] font-normal text-[#593B37] bg-orange-light-active rounded-lg">Trọng sinh</span>
            <span class="px-2.5 py-1 max-sm:text-[0.875rem] md:text-[1.5rem] font-normal text-[#593B37] bg-orange-light-active rounded-lg">Thế thân</span>
            </div>
            <div
              class="flex flex-wrap gap-4 items-center justify-center mt-2.5 max-sm:text-[1.125rem] md:text-[1.875rem] font-normal text-orange-light max-md:max-w-full"
            >
  ...
  <div class="flex md:flex-row flex-col w-full max-md:max-w-full">
      ...
      <h2 id="introduction-title" class="gap-2.5 self-start p-2.5 max-sm:text-[1.125rem] md:text-[1.875rem] font-medium text-red-normal bg-orange-light-hover rounded-xl">
          Giới thiệu
      </h2>
      <div class="flex overflow-x-auto flex-1 mt-3 max-sm:text-[1rem] md:text-[1.75rem] whitespace-nowrap bg-white size-full text-[#593B37]" role="region" aria-label="Scrollable content">
      </div>
      <div class="flex-1 shrink basis-0 text-ellipsis max-sm:text-[1rem] md:text-[1.75rem] font-normal text-[#593B37]">
      ...
      <h2 id="chapter-list-title" class="gap-2.5 self-start p-2.5 max-sm:text-[1.125rem] md:text-[1.875rem] font-medium text-red-normal bg-orange-light-hover rounded-xl">
          Chương truyện
      </h2>
      <nav class="flex overflow-x-auto flex-col justify-center mt-3 w-full bg-white text-[#593B37]" aria-label="Chapter navigation">
          ...
          <li class="flex gap-2.5 justify-center items-center py-1.5 w-full border-solid border-b-[0.1px] border-b-[#593B37]/50">
              <a href="#chapter1" class="flex-1 shrink self-stretch my-auto max-sm:text-[1rem] md:text-[1.75rem] font-medium basis-0">Chương 1</a>
              <span class="self-stretch my-auto max-sm:text-[0.875rem] md:text-[1.5rem] font-normal">10 tiếng trước</span>
          </li>
          <li class="flex gap-2.5 justify-center items-center py-1.5 w-full border-solid border-b-[0.1px] border-b-[#593B37]/50">
              <a href="#chapter2" class="flex-1 shrink self-stretch my-auto max-sm:text-[1rem] md:text-[1.75rem] font-medium basis-0">Chương 2</a>
              <span class="self-stretch my-auto max-sm:text-[0.875rem] md:text-[1.5rem] font-normal">10 tiếng trước</span>
          </li>
          <li class="flex gap-2.5 justify-center items-center py-1.5 w-full border-solid border-b-[0.1px] border-b-[#593B37]/50">
              <a href="#chapter3" class="flex-1 shrink self-stretch my-auto max-sm:text-[1rem] md:text-[1.75rem] font-medium basis-0">Chương 3</a>
              <span class="self-stretch my-auto max-sm:text-[0.875rem] md:text-[1.5rem] font-normal">10 tiếng trước</span>
          </li>
          <li class="flex gap-2.5 justify-center items-center py-1.5 w-full border-solid border-b-[0.1px] border-b-[#593B37]/50">
              <a href="#chapter4" class="flex-1 shrink self-stretch my-auto max-sm:text-[1rem] md:text-[1.75rem] font-medium basis-0">Chương 4</a>
              <span class="self-stretch my-auto max-sm:text-[0.875rem] md:text-[1.5rem] font-normal">10 tiếng trước</span>
          </li>
          <li class="flex gap-2.5 justify-center items-center py-1.5 w-full border-solid border-b-[0.1px] border-b-[#593B37]/50">
              <a href="#chapter5" class="flex-1 shrink self-stretch my-auto max-sm:text-[1rem] md:text-[1.75rem] font-medium basis-0">Chương 5</a>
              <span class="self-stretch my-auto max-sm:text-[0.875rem] md:text-[1.5rem] font-normal">10 tiếng trước</span>
          </li>
          <li class="flex gap-2.5 justify-center items-center py-1.5 w-full border-solid border-b-[0.1px] border-b-[#593B37]/50">
              <a href="#chapter6" class="flex-1 shrink self-stretch my-auto max-sm:text-[1rem] md:text-[1.75rem] font-medium basis-0">Chương 6</a>
              <span class="self-stretch my-auto max-sm:text-[0.875rem] md:text-[1.5rem] font-normal">10 tiếng trước</span>
          </li>
          <li class="flex gap-2.5 justify-center items-center py-1.5 w-full border-solid border-b-[0.1px] border-b-[#593B37]/50">
              <a href="#chapter7" class="flex-1 shrink self-stretch my-auto max-sm:text-[1rem] md:text-[1.75rem] font-medium basis-0">Chương 7</a>
              <span class="self-stretch my-auto max-sm:text-[0.875rem] md:text-[1.5rem] font-normal">10 tiếng trước</span>
          </li>
          <li class="flex gap-2.5 justify-center items-center py-1.5 w-full border-solid border-b-[0.1px] border-b-[#593B37]/50">
              <a href="#chapter8" class="flex-1 shrink self-stretch my-auto max-sm:text-[1rem] md:text-[1.75rem] font-medium basis-0">Chương 8</a>
              <span class="self-stretch my-auto max-sm:text-[0.875rem] md:text-[1.5rem] font-normal">10 tiếng trước</span>
          </li>
          <li class="flex gap-2.5 justify-center items-center py-1.5 w-full border-solid border-b-[0.1px] border-b-[#593B37]/50">
              <a href="#chapter9" class="flex-1 shrink self-stretch my-auto max-sm:text-[1rem] md:text-[1.75rem] font-medium basis-0">Chương 9</a>
              <span class="self-stretch my-auto max-sm:text-[0.875rem] md:text-[1.5rem] font-normal">10 tiếng trước</span>
          </li>
          <li class="flex gap-2.5 justify-center items-center py-1.5 w-full">
              <a href="#chapter10" class="flex-1 shrink self-stretch my-auto max-sm:text-[1rem] md:text-[1.75rem] font-medium basis-0">Chương 10</a>
              <span class="self-stretch my-auto max-sm:text-[0.875rem] md:text-[1.5rem] font-normal">10 tiếng trước</span>
          </li>
          </ul>
    ...
    <aside class="w-full md:w-4/12 box-border bg-red-light bg-white p-4 md:p-8 max-md:mt-4 flex flex-col items-center  mx-auto"aria-labelledby="hot-list">
      ...
      <button
        class="gap-2.5 self-stretch py-2.5 px-2 text-red-light bg-red-normal rounded-[12px] max-sm:text-[1.125rem]  md:text-[1.5rem]"
        role="tab"
        aria-selected="true"
      >
        Ngày
      ...
      <button
        class="gap-2.5 self-stretch py-2.5 px-2 bg-red-light rounded-[12px] max-sm:text-[1.125rem]  md:text-[1.5rem]"
        role="tab"
      >
        Tuần
      </button>
      ...
      <div class="flex flex-col items-center mt-[12px] md:mt-[24px] w-full" role="tabpanel">
        ...
        <span
            class="gap-2.5 self-center my-auto w-[2rem] h-[2rem] max-sm:text-[1rem] md:text-[1.25rem] p-0.5 font-medium text-center text-red-normal whitespace-nowrap rounded-[2px] border" style="border-color: #D56665 !important;"
            >1</span
          >
          <img
            loading="lazy"
          ...
          />
          <div
            class="flex flex-col flex-1 shrink self-stretch my-auto basis-0 "
          >
            <h3
              class="flex-1 shrink gap-2.5 self-stretch w-full max-sm:text-[1rem] md:text-[1.75rem] font-medium basis-0 text-orange-darker"
            >
              Thiên quan tứ phúc
            </h3>
            <p
              class="flex-1 shrink gap-2.5 self-stretch mt-2 w-full max-sm:text-[1rem] md:text-[1.5rem] text-normal text-red-normal basis-0"
            >
              Thể loại: HE, hắc đạo
            </p>
            <div class="flex gap-1 items-start self-start mt-[4px] ">
              <div class="flex items-start" aria-label="Rating: 4 out of 5">
                <span class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.25rem] md:h-[1.75rem] max-sm:text-[1rem] md:text-[1.5rem]">★</span>
                <span class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.25rem] md:h-[1.75rem] max-sm:text-[1rem] md:text-[1.5rem]">★</span>
                <span class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.25rem] md:h-[1.75rem] max-sm:text-[1rem] md:text-[1.5rem]">★</span>
                <span class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.25rem] md:h-[1.75rem] max-sm:text-[1rem] md:text-[1.5rem]">★</span>
                <span class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.25rem] md:h-[1.75rem] max-sm:text-[1rem] md:text-[1.5rem]">★</span>
              </div>
              <span class="max-sm:text-[1rem] md:text-[1.5rem] text-normal text-red-normal">4</span>
            </div>
            <p
              class="flex-1 shrink gap-2.5 self-stretch mt-2 w-full max-sm:text-[1rem] md:text-[1.5rem] text-red-normal basis-0"
            >
              Số chữ: 24.7K
            </p>
          </div>
        ...
        <article class="flex gap-3 items-center w-full mb-[12px] md:mb-[24px]">
          <span
            class="gap-2.5 self-center my-auto w-[2rem] h-[2rem] p-0.5 max-sm:text-[1rem] md:text-[1.25rem] font-medium text-center text-red-normal whitespace-nowrap rounded-[2px] border" style="border-color: #D56665 !important;"
            >2</span
          >
          <img
            loading="lazy"
        ...
        <article class="flex gap-3 items-center w-full mb-[12px] md:mb-[24px]">
          <span
            class="gap-2.5 self-center items-center my-auto w-[2rem] h-[2rem] p-0.5 max-sm:text-[1rem] md:text-[1.25rem] font-medium text-center text-red-normal whitespace-nowrap rounded-[2px] border" style="border-color: #D56665 !important;"
            >3</span
          >
          <img
            loading="lazy"
    ...
    <div class="flex flex-col w-full rounded-none">
      <!-- Tiêu đề
      <h2 class="gap-2.5 self-start p-[10px] md:px-[20px] ml-[17px] md:ml-[34px] mb-[-3px] max-sm:text-[1.125rem]  md:text-[2.25rem] font-semibold text-red-normal bg-red-light rounded-tl-[12px] rounded-tr-[12px]">
        Truyện đề cử
      </h2> -->
      ...
      <article class="flex flex-col self-stretch my-auto min-h-[261px] w-[121px] shrink-0 md:w-auto" role="listitem">
          ...
          <span class="gap-2.5 self-start px-[2px] mt-[4px] md:my-[8px] max-sm:text-[0.75rem] md:text-[1.25rem] font-medium text-red-light whitespace-nowrap bg-red-normal rounded-[2px]">Full</span>
          <div class="flex flex-col mt-[4px] w-full">
            <h3 class="flex-1 shrink gap-2.5 self-stretch w-full max-sm:text-[1rem] md:text-[1.75rem] font-medium basis-0 text-orange-darker break-words">
              Thiên Quan Tứ Phúc
            </h3>
            <div class="flex gap-1 items-start self-start mt-[4px] ">
              <div class="flex items-start" aria-label="Rating: 4 out of 5">
                <span class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.75rem] md:h-[1.75rem] max-sm:text-[1rem] md:text-[2rem]">★</span>
                <span class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.75rem] md:h-[1.75rem] max-sm:text-[1rem] md:text-[2rem]">★</span>
                <span class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.75rem] md:h-[1.75rem] max-sm:text-[1rem] md:text-[2rem]">★</span>
                <span class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.75rem] md:h-[1.75rem] max-sm:text-[1rem] md:text-[2rem]">★</span>
                <span class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.75rem] md:h-[1.75rem] max-sm:text-[1rem] md:text-[2rem]">★</span>
              </div>
              <span class="max-sm:text-[0.625rem] md:text-[1.25rem] text-normal text-red-normal md:mt-1.5">4</span>
            </div>
            <p class="flex-1 shrink gap-2.5 self-stretch mt-1 w-full max-sm:text-[0.875rem] md:text-[1.5rem] text-normal text-red-normal basis-0">
              Chương 120
            </p>
          </div>
        </article>
        ...
        <article class="flex flex-col self-stretch my-auto min-h-[261px] w-[121px] shrink-0 md:w-auto" role="listitem">
          ...
          <div class="flex flex-col mt-[4px] w-full">
            ...
            <div class="flex gap-1 items-start self-start mt-[4px] ">
              ...
              <span class="max-sm:text-[0.625rem] md:text-[1.25rem] text-normal text-red-normal md:mt-[6px]">4</span>
            </div>
            <p class="flex-1 shrink gap-2.5 self-stretch mt-1 w-full max-sm:text-[0.875rem] md:text-[1.5rem] text-normal text-red-normal basis-0">
              Chương 120
            </p>
        ...
        <article class="flex flex-col self-stretch my-auto min-h-[261px] w-[121px] shrink-0 md:w-auto" role="listitem">
          ...
          <div class="flex flex-col mt-[4px] w-full">
            ...
            <p class="flex-1 shrink gap-2.5 self-stretch mt-1 w-full max-sm:text-[0.875rem] md:text-[1.25rem] text-normal text-red-normal basis-0">
              Chương 120
            </p>
          </div>
        </article>

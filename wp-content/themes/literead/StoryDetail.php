...
<main class="home w-full max-md:max-w-full">
    ...
    <div class="flex flex-col justify-start items-center mx-auto w-full ">
        ...
        <div class="flex flex-col items-start mt-3 lg:w-3/4 sm:w-2/3 w-[24.625rem] gap-2.5 justify-end">
            ...
            <div class="flex items-end self-center my-auto text-[20px] md:text-[2rem]" role="img" aria-label="4 out of 5 stars">
            ...
            <span class="self-stretch my-auto text-[18px] md:text-[1.875rem] text-red-normal">4</span>
            </div>
            ...
            <span class="px-2.5 py-1 text-[14px] md:text-[1.5rem] font-normal text-[#593B37] bg-orange-light-active rounded-lg">HE</span>
            <span class="px-2.5 py-1 text-[14px] md:text-[1.5rem] font-normal text-[#593B37] bg-orange-light-active rounded-lg">Ngôn tình</span>
            <span class="px-2.5 py-1 text-[14px] md:text-[1.5rem] font-normal text-[#593B37] bg-orange-light-active rounded-lg">Ngọt sủng</span>
            <span class="px-2.5 py-1 text-[14px] md:text-[1.5rem] font-normal text-[#593B37] bg-orange-light-active rounded-lg">Cổ đại</span>
            <span class="px-2.5 py-1 text-[14px] md:text-[1.5rem] font-normal text-[#593B37] bg-orange-light-active rounded-lg">Trọng sinh</span>
  ...
  <div class="flex md:flex-row flex-col w-full max-md:max-w-full">
      ...
      <h2 id="introduction-title" class="gap-2.5 self-start p-2.5 text-[18px] md:text-[1.875rem] font-medium text-red-normal bg-orange-light-hover rounded-xl">
          Giới thiệu
      </h2>
      <div class="flex overflow-x-auto flex-1 mt-3 text-[16px] md:text-[1.75rem] whitespace-nowrap bg-white size-full text-[#593B37]" role="region" aria-label="Scrollable content">
      </div>
      <div class="flex-1 shrink basis-0 text-ellipsis text-[16px] md:text-[1.75rem] font-normal text-[#593B37]">
      ...
      <h2 id="chapter-list-title" class="gap-2.5 self-start p-2.5 text-[18px] md:text-[1.875rem] font-medium text-red-normal bg-orange-light-hover rounded-xl">
          Chương truyện
      </h2>
      <nav class="flex overflow-x-auto flex-col justify-center mt-3 w-full bg-white text-[#593B37]" aria-label="Chapter navigation">
          ...
          <li class="flex gap-2.5 justify-center items-center py-1.5 w-full border-solid border-b-[0.1px] border-b-[#593B37]/50">
              <a href="#chapter1" class="flex-1 shrink self-stretch my-auto text-[16px] md:text-[1.75rem] font-medium basis-0">Chương 1</a>
              <span class="self-stretch my-auto text-[14px] md:text-[1.5rem] font-normal">10 tiếng trước</span>
          </li>
          <li class="flex gap-2.5 justify-center items-center py-1.5 w-full border-solid border-b-[0.1px] border-b-[#593B37]/50">
              <a href="#chapter2" class="flex-1 shrink self-stretch my-auto text-[16px] md:text-[1.75rem] font-medium basis-0">Chương 2</a>
              <span class="self-stretch my-auto text-[14px] md:text-[1.5rem] font-normal">10 tiếng trước</span>
          </li>
          <li class="flex gap-2.5 justify-center items-center py-1.5 w-full border-solid border-b-[0.1px] border-b-[#593B37]/50">
              <a href="#chapter3" class="flex-1 shrink self-stretch my-auto text-[16px] md:text-[1.75rem] font-medium basis-0">Chương 3</a>
              <span class="self-stretch my-auto text-[14px] md:text-[1.5rem] font-normal">10 tiếng trước</span>
          </li>
          <li class="flex gap-2.5 justify-center items-center py-1.5 w-full border-solid border-b-[0.1px] border-b-[#593B37]/50">
              <a href="#chapter4" class="flex-1 shrink self-stretch my-auto text-[16px] md:text-[1.75rem] font-medium basis-0">Chương 4</a>
              <span class="self-stretch my-auto text-[14px] md:text-[1.5rem] font-normal">10 tiếng trước</span>
          </li>
          <li class="flex gap-2.5 justify-center items-center py-1.5 w-full border-solid border-b-[0.1px] border-b-[#593B37]/50">
              <a href="#chapter5" class="flex-1 shrink self-stretch my-auto text-[16px] md:text-[1.75rem] font-medium basis-0">Chương 5</a>
              <span class="self-stretch my-auto text-[14px] md:text-[1.5rem] font-normal">10 tiếng trước</span>
          </li>
          <li class="flex gap-2.5 justify-center items-center py-1.5 w-full border-solid border-b-[0.1px] border-b-[#593B37]/50">
              <a href="#chapter6" class="flex-1 shrink self-stretch my-auto text-[16px] md:text-[1.75rem] font-medium basis-0">Chương 6</a>
              <span class="self-stretch my-auto text-[14px] md:text-[1.5rem] font-normal">10 tiếng trước</span>
          </li>
          <li class="flex gap-2.5 justify-center items-center py-1.5 w-full border-solid border-b-[0.1px] border-b-[#593B37]/50">
              <a href="#chapter7" class="flex-1 shrink self-stretch my-auto text-[16px] md:text-[1.75rem] font-medium basis-0">Chương 7</a>
              <span class="self-stretch my-auto text-[14px] md:text-[1.5rem] font-normal">10 tiếng trước</span>
          </li>
          <li class="flex gap-2.5 justify-center items-center py-1.5 w-full border-solid border-b-[0.1px] border-b-[#593B37]/50">
              <a href="#chapter8" class="flex-1 shrink self-stretch my-auto text-[16px] md:text-[1.75rem] font-medium basis-0">Chương 8</a>
              <span class="self-stretch my-auto text-[14px] md:text-[1.5rem] font-normal">10 tiếng trước</span>
          </li>
          <li class="flex gap-2.5 justify-center items-center py-1.5 w-full border-solid border-b-[0.1px] border-b-[#593B37]/50">
              <a href="#chapter9" class="flex-1 shrink self-stretch my-auto text-[16px] md:text-[1.75rem] font-medium basis-0">Chương 9</a>
              <span class="self-stretch my-auto text-[14px] md:text-[1.5rem] font-normal">10 tiếng trước</span>
          </li>
          <li class="flex gap-2.5 justify-center items-center py-1.5 w-full">
              <a href="#chapter10" class="flex-1 shrink self-stretch my-auto text-[16px] md:text-[1.75rem] font-medium basis-0">Chương 10</a>
              <span class="self-stretch my-auto text-[14px] md:text-[1.5rem] font-normal">10 tiếng trước</span>
          </li>
          </ul>
          ...
          <button aria-label="Page 1" class="self-stretch px-0.5 my-auto text-orange-light text-[18px] md:text-[1.875rem] bg-[#D56665] rounded-lg aspect-[1/1] h-[30px] min-h-[30px] w-[30px] flex items-center justify-center" aria-current="page">1</button>
          <button aria-label="Page 2" class="self-stretch px-0.5 my-auto bg-[#FFF2F0] text-[16px] md:text-[1.75rem] rounded-lg aspect-[1/1] h-[30px] min-h-[30px] w-[30px] flex items-center justify-center">2</button>
          <button aria-label="Page 3" class="self-stretch px-0.5 my-auto bg-[#FFF2F0] text-[16px] md:text-[1.75rem] rounded-lg aspect-[1/1] h-[30px] min-h-[30px] w-[30px] flex items-center justify-center">3</button>
          <span class="self-stretch px-0.5 my-auto bg-[#FFF2F0] rounded-lg text-[16px] md:text-[1.75rem] aspect-[1/1] h-[30px] min-h-[30px] w-[30px] flex items-center justify-center">...</span>
          <button aria-label="Page 6" class="self-stretch px-0.5 my-auto bg-[#FFF2F0] text-[16px] md:text-[1.75rem] rounded-lg aspect-[1/1] h-[30px] min-h-[30px] w-[30px] flex items-center justify-center">6 </button>
          <button aria-label="Next page" class="self-stretch px-0.5 my-auto bg-[#FFF2F0] text-[16px] md:text-[1.75rem] rounded-lg aspect-[1/1] h-[30px] min-h-[30px] w-[30px] flex items-center justify-center">&gt;</button>
          </nav>
      </nav>
      </section>

      <section class="flex flex-col  bg-white" aria-label="Comment Section">
        <h2 id="comment" class="gap-2.5 self-start p-2.5 text-[18px] md:text-[1.875rem] font-medium text-red-normal bg-orange-light-hover rounded-xl">
        Bình luận
        </h2> 
          ...
          >
            ...
            <div class="flex-1 shrink basis-0  max-md:max-w-full">
              ...
              >
                ...
                <time class="self-stretch my-auto text-[14px] md:text-[1.5rem] text-right"
                  >9 giờ trước</time
                >
              </header>
              <p
      ...
      <div class="flex flex-col items-center mt-[12px] md:mt-[24px] w-full" role="tabpanel">
        ...
        <span
          ...
          >
            ...
            <p
              class="flex-1 shrink gap-2.5 self-stretch mt-2 w-full text-[16px] md:text-[1.5rem] text-normal text-red-normal basis-0"
            >
              Thể loại: HE, hắc đạo
            </p>
            <div class="flex gap-1 items-start self-start mt-[4px] ">
              <div class="flex items-start" aria-label="Rating: 4 out of 5">
                <span class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.25rem] md:h-[1.75rem] text-[16px] md:text-[1.5rem]">★</span>
                <span class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.25rem] md:h-[1.75rem] text-[16px] md:text-[1.5rem]">★</span>
                <span class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.25rem] md:h-[1.75rem] text-[16px] md:text-[1.5rem]">★</span>
                <span class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.25rem] md:h-[1.75rem] text-[16px] md:text-[1.5rem]">★</span>
                <span class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.25rem] md:h-[1.75rem] text-[16px] md:text-[1.5rem]">★</span>
              </div>
              <span class="text-[16px] md:text-[1.5rem] text-normal text-red-normal">4</span>
            </div>
            <p
              class="flex-1 shrink gap-2.5 self-stretch mt-2 w-full text-[16px] md:text-[1.5rem] text-red-normal basis-0"
            >
              Số chữ: 24.7K
            </p>
          </div>
    ...
    <div class="flex flex-col w-full rounded-none">
      ...
      <article class="flex flex-col self-stretch my-auto min-h-[261px] w-[121px] shrink-0 md:w-auto" role="listitem">
          ...
          <span class="gap-2.5 self-start px-[2px] mt-[4px] md:my-[8px] text-[12px] md:text-[1.25rem] font-medium text-red-light whitespace-nowrap bg-red-normal rounded-[2px]">Full</span>
          <div class="flex flex-col mt-[4px] w-full">
            <h3 class="flex-1 shrink gap-2.5 self-stretch w-full text-[16px] md:text-[1.75rem] font-medium basis-0 text-orange-darker break-words">
              Thiên Quan Tứ Phúc
            </h3>
            <div class="flex gap-1 items-start self-start mt-[4px] ">
              <div class="flex items-start" aria-label="Rating: 4 out of 5">
                <span class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.75rem] md:h-[1.75rem] text-[16px] md:text-[2rem]">★</span>
                <span class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.75rem] md:h-[1.75rem] text-[16px] md:text-[2rem]">★</span>
                <span class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.75rem] md:h-[1.75rem] text-[16px] md:text-[2rem]">★</span>
                <span class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.75rem] md:h-[1.75rem] text-[16px] md:text-[2rem]">★</span>
                <span class="text-[#FFC700] w-[1rem] h-[1rem] md:w-[1.75rem] md:h-[1.75rem] text-[16px] md:text-[2rem]">★</span>
            ...
            <p class="flex-1 shrink gap-2.5 self-stretch mt-1 w-full text-[14px] md:text-[1.5rem] text-normal text-red-normal basis-0">
              Chương 120
            </p>
          </div>
        </article>
        ...
        <article class="flex flex-col self-stretch my-auto min-h-[261px] w-[121px] shrink-0 md:w-auto" role="listitem">
          ...
          <div class="flex flex-col mt-[4px] w-full">
            ...
            <p class="flex-1 shrink gap-2.5 self-stretch mt-1 w-full text-[14px] md:text-[1.25rem] text-normal text-red-normal basis-0">
              Chương 120
            </p>
          </div>
        </article>

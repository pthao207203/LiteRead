...
<main class="home">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <section class="flex gap-4 align-center mx-[17px] my-[12px] text-black z-0"
          style="max-width: 1000px; min-width: 320px; transition: width 0.3s ease;">
          
          <!-- Background Image -->
          <div class="absolute top-0 start-0 w-full h-full bg-cover bg-center overflow-hidden z-0"
              style="background-image: url('https://cdn.builder.io/api/v1/image/assets/TEMP/6cb997f442ff8363c94eeeb408cb0060c25e45a10b7e8b7b91ed25ed76201975'); opacity: 0.8; filter: blur(4px); transform: scale(1.1);">

            <!-- Gradient & Blur Overlay -->
            <div class="absolute top-[5px] start-0 w-full h-full z-10"
          ...
          <!-- Content -->
          <div class="relative rounded-[8px] overflow-hidden" style="flex: 1; min-width: 100px; max-width: 250px;">
            <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/6cb997f442ff8363c94eeeb408cb0060c25e45a10b7e8b7b91ed25ed76201975"
                ...
                class="img-fluid h-full object-cover z-10 w-[115px]" style="aspect-ratio: 0.7;">
          </div>

          <article class="flex flex-col justify-end flex-1 z-10">
            <div class="flex gap-2 items-center">
              <span class="p-[4px] font-medium bg-red-normal text-[16px] text-white font-montserrat rounded-[2px]">Full</span>
              <div class="flex items-center text-[20px] font-medium text-white ">
                <span>4.5</span>

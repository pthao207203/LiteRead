      ...
      <section id="mainContent"
        ...
        <div class="grow w-full bg-white  max-md:max-w-full h-[calc(100vh-4.425rem)]">
          <div class="flex flex-col justify-center items-start p-10 w-full max-md:px-6 max-md:max-w-full">
            ...
            <!-- Tổng xu -->
            <div
              class="flex flex-col mt-12 max-w-full text-3xl tracking-wide leading-none text-[#A04D4C] w-[394px] max-md:mt-10">
              <div class="font-semibold">Tổng xu</div>
              <div
                class="flex overflow-hidden flex-col justify-center py-4 mt-2 w-full font-medium whitespace-nowrap border-b border-solid border-b-[#A04D4C]">
            ...
            <!-- Pop-up hoàn tất -->
            <div id="successPopup" class="hidden fixed inset-0 items-center justify-center bg-black bg-opacity-50">
              <div class="bg-white rounded-3xl p-[3rem] shadow-lg text-center w-[36rem]">
            ...
            <!-- Lịch sử giao dịch -->
            <div
              class="flex flex-col mt-12 max-w-full text-3xl tracking-wide leading-none text-[#A04D4C] w-[708px] max-sm:p-10 max-md:mt-10">

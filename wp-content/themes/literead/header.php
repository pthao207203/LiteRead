...
<body <?php body_class(); ?> style="font-family: 'Montserrat', sans-serif !important;">
  ...
  <!-- === Header === -->
  <header
    class="fixed top-0 right-0 left-0 flex items-center md:px-[2.125rem] md:py-[0.625rem] p-[0.625rem] gap-[1rem] md:gap-[2.875rem] w-full bg-orange-light-active z-50">

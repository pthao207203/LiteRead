...
<body <?php body_class(); ?>>
  ...
  <header>
    <nav class="overflow-hidden w-full bg-red-100">
      <div class="flex justify-between items-center px-4 py-1.5 w-full bg-red-100">
        ...
        <div class="flex gap-2.5 items-center self-stretch my-auto">
          <button class="flex shrink-0 self-stretch my-auto w-6 h-6" aria-label="Search">
            <span class="sr-only">Search</span>
          </button>
          <button class="flex shrink-0 self-stretch my-auto w-6 h-6" aria-label="User profile">
          ...
          <button class="self-stretch my-auto w-[30px]" aria-label="Menu">
            ...
            <div class="flex mt-1.5 w-full bg-red-normal min-h-0.5 rounded-[99px]"></div>
            <div class="flex mt-1.5 w-full bg-red-normal min-h-0.5 rounded-[99px]"></div>
          </button>
        </div>
      </div>
